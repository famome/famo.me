        ...
        enableKeymovement: function(currentSurf, currentMod, currentRenderController) {
            ...
            var keyListener = function(currentMod) {
                ...
                window.onkeydown = function(event) {
                    ...
                    var currentTransform = currentMod.modify().transform;
                    tx = currentTransform[12];
                    ty = currentTransform[13];
                    tz = currentTransform[14];
